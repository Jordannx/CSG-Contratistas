...
<head>
    ...
    <title>Trabajos en Drywall | CSG Contratistas Generales</title>
...
<div class="container">
    ...
    <div class="image-section">
        <img src="css/imagenes/servicio1.png" alt="Imagen de trabajos en Drywall">
    </div>

    <!-- Sección de contenido principal -->
    <div class="content-section">
        <h2>TRABAJOS EN DRYWALL</h2>
        <p>
            C.S.G CONTRATISTAS GENERALES se especializa en la instalación y construcción de sistemas de drywall, ofreciendo soluciones versátiles que se adaptan a diversas necesidades arquitectónicas. Nuestros servicios incluyen la creación de tabiques, cielorrasos y revestimientos, todo realizado con materiales de alta calidad y técnicas de vanguardia.
        </p>
        <p>
            Nuestro equipo de expertos garantiza resultados excepcionales en términos de acabado, durabilidad y funcionalidad, asegurando que cada proyecto cumpla con los más altos estándares de calidad y estética. Nos comprometemos a entregar cada trabajo en los plazos establecidos, proporcionando una experiencia de servicio eficiente y profesional.
        </p>
    </div>
